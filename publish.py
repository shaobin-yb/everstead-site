...
ROOT_ARTIFACTS = [
    ...
    ("直接交易对手库", "tools/counterparty/counterparty.html", "2026-09-11", "🏦", "lan",
     "在库授信对手 468 家(授信总额 1.95 万亿) + 历史出库 58 家 · 评级/额度/省份/分析师筛选 · 🔒 密码访问 · 仅公司内网"),
    ...
    ("金融客户名单·精选版", "client-list-lite.html", "2026-09-10", "🏛️", "lan",
     "980 家市级及以上机构 · 8类Tab一眼抓重点 · 剔除联合社/信用社/县级农商行 · 🔒 密码访问 · 仅公司内网"),
    ("CRM 未分配客户池", "tools/unassigned/unassigned.html", "2026-09-14", "🎯", "lan",
     "356 家未分配团队客户 · 搜索/类型/地域筛选 + 条形图联动 · 导出CSV · 🔒 密码访问 · 仅公司内网"),
